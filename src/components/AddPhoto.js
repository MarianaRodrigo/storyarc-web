...
export default function Photo(props) {
    ...
    return (
        <section className="container">
            {files.length == 0 ? 
            <div  {...getRootProps({ className: 'dropzone', style })} className="shadow appearance-none border rounded w-full py-6 px-3 text-gray-700 font-light tracking-wide leading-tight focus:outline-none focus:shadow-outline">
                <svg class="w-28 h-28 m-auto rotate-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
                <p className="flex justify-center mb-6 text-sm select-none">Adiciona uma fotografia</p>
            ...
            <aside className="flex">
              ...
              {files.map((file, i) => (
                <div className="grow border border-sky-500" onClick={() => removeImage(i)}  key={file.name}
                    style={{
                        height: "12.5rem", 
