        ...
        >
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="p-6 space-y-6">
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 font-light tracking-wide leading-tight focus:outline-none focus:shadow-outline pb-12"
                type="text"
                placeholder="Adiciona uma descrição"
              ></input>
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 font-light tracking-wide leading-tight focus:outline-none focus:shadow-outline"
                type="text"
            ...
            <div className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200">
              <button
                type="button"
                className="text-white bg-verde focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
                Adicionar
              </button>
              <button
